...
public class BuggyArena {
    ...
    static int applyDamage(int hp, int damage) {
        return hp - damage; // you gotta subtract the damage not add it.
    }

    static String describe(int hp) {
        if (hp == 0) return "defeated"; // It was a "=" operator, not a "==" operator.
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < enemyHp.length; i++) // It's not "<=" because it can't get to 3, it can only count 0, 1, and 2. 
        {
